 ...
 * This directive extends the functionality of AngularJS ngMessages directive allowing to 
 * pass the error messages in a js/json object.
 * Native funtionality for reusing messages is done in `ngMessages` with the `ngMessagesInclude`
 * but this feature relies on HTML templates. With this extension you can pass messages in 
 * a js/json object.
