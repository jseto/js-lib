...
* Description
*/
angular.module('jsLib.widgets.scrollList', []).
...
directive('jswScrollList', function( $compile, JSLIB_TEMPLATE_PATH ){
	return {
		...
		templateUrl: function( element, attrs ){
			return attrs.template ? attrs.template : JSLIB_TEMPLATE_PATH + 'scroll-list.html';
		},
	};
})

.controller('ScrollListCtrl', function($scope ) {
